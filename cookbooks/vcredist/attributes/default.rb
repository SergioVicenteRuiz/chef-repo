...
default['vcredist_x86']['install_source'] = "http://yum.#{node['domain']}:8080/vcredist/vcredist_x86.exe"
...
if kernel.machine =~ /x86_64/
  default['vcredist_x64']['install_source'] = "http://yum.#{node['domain']}:8080/vcredist/vcredist_x64.exe"
